  ...
  public static void main(String[] args) {
    ...
    /*Authenticator.setDefault(new Authenticator() {
	    protected PasswordAuthentication getPasswordAuthentication() {
	        return new PasswordAuthentication("phx-dc\\jamajama","xxxx".toCharArray());
	    }
  	});*/
    
    Proxy proxy = new Proxy(Proxy.Type.HTTP, new InetSocketAddress("globalproxy.dhl.com", 8080));
